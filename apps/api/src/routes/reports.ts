...
router.post('/generate/:programId', authenticate, isOfficer, async (req, res) => {
...
router.get('/:programId/status', authenticate, isOfficer, async (req, res) => {
...
router.get('/:programId/download', authenticate, isOfficer, async (req, res) => {
