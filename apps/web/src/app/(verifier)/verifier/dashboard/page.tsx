...
import { MapPin, AlertTriangle, CheckCircle2, TrendingUp, ArrowRight, Clock, User } from 'lucide-react'
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center gap-5 mt-2 ml-6 text-xs text-gray-500 flex-wrap">
                          <span className="flex items-center gap-1">
                            ...
                            Score: <strong className="text-gray-800">{app.composite_score != null ? Number(app.composite_score).toFixed(1) : ''}</strong>
                          </span>
                          {a.due_date && (
                            <span className="flex items-center gap-1">
