...
import { MapPin, AlertTriangle, CheckCircle2, ArrowRight, User } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className="bg-white border-b border-gray-300 px-6 py-4">
        ...
        <p className="text-sm text-gray-500 mt-0.5">Your field visit assignments — conduct visits in the order shown below</p>
      </div>
                  ...
                  <div key={a.id} className={`bg-white border rounded overflow-hidden
                    ...
                    <div className="px-5 py-4 flex items-start justify-between gap-4">
                      ...
                      {isPending ? (
                        ...
                        <Link href={`/verifier/visit/${a.id}`}
                          className="flex-shrink-0 inline-flex items-center gap-2 px-4 py-2 bg-green-700 hover:bg-green-800 text-white font-semibold text-sm rounded transition-colors">
