...
const STATUS_LABEL: Record<string, string> = {
  draft:'Draft', submitted:'Submitted', anomaly_checking:'Fraud Check', anomaly_flagged:'Flagged',
  scoring_pending:'Processing', shortlisted:'Shortlisted', not_shortlisted:'Not Shortlisted',
  scored:'Scored', verification_pending:'Verif. Pending', verification_complete:'Verified',
          ...
          <>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                { label: 'Avg Integrity Adj', value: data.scoreStats._avg.integrity_adj != null ? Number(data.scoreStats._avg.integrity_adj).toFixed(1) : '', sub: 'Avg deduction', cls: 'text-red-600' },
