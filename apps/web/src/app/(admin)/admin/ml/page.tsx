        ...
        {loading ? (
          ...
          <>
            ...
            <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-6">
              <h2 className="font-bold text-slate-900 mb-3">Composite Formula (H-05)</h2>
              <div className="bg-slate-50 rounded-xl p-4 text-sm text-slate-700 font-mono text-center">
                COMPOSITE = <span className="text-blue-700 font-bold">0.35</span>  merit +{' '}
              ...
              <div className="flex items-start gap-2 mt-3 text-xs text-slate-400">
                ...
                100% rule-based. No ML blend (H-03 deactivated). Integrity includes G-08 anomaly deduction if flagged.
              </div>
            </div>
            ...
            <div className="bg-slate-50 rounded-2xl border border-slate-200 p-5">
              ...
              <div className="grid md:grid-cols-3 gap-3 text-sm">
                {[
                  ...
                  { step: 'Phase 3', desc: '45 SCORE rules (AF) compute merit + need. 8 G-rules check integrity. All rule-based.', color: 'border-blue-200 bg-blue-50' },
