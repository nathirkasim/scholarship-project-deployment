...
import { BookMarked, Plus, CheckCircle2, XCircle, Users, Edit2, X } from 'lucide-react'
...
const EMPTY: Partial<Program> = {
  program_code: '', program_name: '', academic_year: '', total_seats: 50, waitlist_seats: 50, is_active: true,
}
