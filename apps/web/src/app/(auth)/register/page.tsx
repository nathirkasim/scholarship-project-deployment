        ...
        <div className="hidden lg:flex lg:w-5/12 bg-blue-900 flex-col justify-between p-12 text-white border-r border-blue-800">
          <div>
            ...
            <p className="text-blue-200 text-sm leading-relaxed mb-8">
              Create a free account and complete the online application before the deadline.
            ...
            <ol className="space-y-5">
              {[
                ...
                ['Submit & Track',    'Submit before 31 July 2025 and track your application status online'],
              ].map(([label, sub], i) => (
          ...
          <div className="border-t border-blue-700 pt-4 text-xs text-blue-400 space-y-1">
            <p>Application deadline: <strong className="text-blue-200">31 July 2025</strong></p>
            <p>Results declared: <strong className="text-blue-200">October 2025</strong></p>
          </div>
        </div>
